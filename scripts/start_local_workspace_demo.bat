...
set "HOSTED_WORKSPACE_URL=http://%API_HOST%:%API_PORT%/app/workspace?token=%API_TOKEN%"
set "LEGACY_STAGE12_URL=http://127.0.0.1:%STATIC_PORT%/demo/workspace_ui_moss_stage12/index.html"
set "LEGACY_STAGE13_URL=http://127.0.0.1:%STATIC_PORT%/demo/workspace_ui_moss_stage13/index.html"
set "LEGACY_STAGE14_URL=http://127.0.0.1:%STATIC_PORT%/demo/workspace_ui_moss_stage14/index.html"
set "DEFAULT_DEMO_URL=%HOSTED_WORKSPACE_URL%"
...
echo [1/7] Bootstrapping local workspace demo...
...
echo [4/7] Ensuring static prototype server on %STATIC_PORT%...
...
echo [7/7] Local workspace demo is ready.

echo.
echo Workspace UI engineering demo is preparing.
echo Hosted workspace URL: %HOSTED_WORKSPACE_URL%
echo Legacy Stage 12 URL: %LEGACY_STAGE12_URL%
echo Legacy Stage 13 URL: %LEGACY_STAGE13_URL%
echo Legacy Stage 14 URL: %LEGACY_STAGE14_URL%
