...
class SyntheticUser:
    ...
    relational_defense_model: dict[str, Any] = field(default_factory=dict)
    communication_behavior_model: dict[str, Any] = field(default_factory=dict)
    behavior_generation_rules: list[dict[str, Any]] = field(default_factory=list)
    persona_schema_meta: dict[str, Any] = field(default_factory=dict)
