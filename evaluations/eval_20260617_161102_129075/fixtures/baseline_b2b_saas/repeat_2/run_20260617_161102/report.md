# Validation Report: Followup Desk
...
Problem: Independent consultants lose follow-up tasks after client calls and messy notes.
Solution: An AI workflow assistant that turns meeting notes into a reviewable action list.
