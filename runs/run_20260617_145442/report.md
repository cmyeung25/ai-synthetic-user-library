...
- mainstream: problem 4.0/5, solution 3.0/5, willingness to pay 3.0/5
...
- The concept appears to depend on personal or workflow data, so trust language and data-minimisation choices will materially affect adoption.

## 12. Assumption Risk Map
- The solution story may still be too abstract or too workflow-dependent.
- Founder messaging still relies on implied value rather than observable outcomes.
